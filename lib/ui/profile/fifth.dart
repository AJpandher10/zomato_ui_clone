      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
                ListTile(
                  title: Text('Ajaybir Singh',style: TextStyles.pageHeading,),
                  subtitle: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text('ajaybir033@gmail.com'),
                      Row(
                        children: <Widget>[
                  ...
                  trailing: CircleAvatar(
                    radius: 30.0,
                    backgroundImage: NetworkImage('https://media.bleacherreport.com/f_auto,w_800,h_533,q_auto,c_fill/br-img-images/003/881/574/hi-res-cb33dd4816dee18a637d5380ce8446a5_crop_north.jpg'),
                  ),
                ),
              Divider(),
              Row(
